...
5. **Spawn Tervis FIRST** — health audit of lead prompt, MEMORY.md, common-prompt, and CLAUDE.md. Lead's memory is most stale-prone (saved last at shutdown). Apply Tervis's recommendations before proceeding.
